...
class C3op_Projects_ActionEventTypes {
    ...
    private static $types = array(
        ...
        C3op_Projects_ActionEventConstants::EVENT_BEGIN_ACKNOWLEDGMENT => "Mudança da data de início",
        C3op_Projects_ActionEventConstants::EVENT_BEGIN_DATE_CHANGE => "Confirmando início de execução",
        C3op_Projects_ActionEventConstants::EVENT_BEGIN_CANCEL_AUTO_START => "Cancelando início automático",
