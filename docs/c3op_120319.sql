...
--
-- Estrutura da tabela `planejamento_projetos`
--

DROP TABLE IF EXISTS `planejamento_projetos`;
CREATE TABLE IF NOT EXISTS `planejamento_projetos` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `titulo` varchar(255) COLLATE latin1_general_ci DEFAULT NULL,
  `cliente` int(10) unsigned DEFAULT NULL,
  `responsavel_iets` int(10) unsigned DEFAULT NULL,
  `responsavel_cliente` int(10) unsigned DEFAULT NULL,
  `data_inicio` date DEFAULT NULL,
  `data_termino` date DEFAULT NULL,
  `valor` float DEFAULT NULL,
  `natureza_contrato` int(10) unsigned DEFAULT NULL,
  `area_atuacao` int(10) unsigned DEFAULT NULL,
  `overhead` float DEFAULT NULL,
  `taxa_administracao` float DEFAULT NULL,
  `objeto` text COLLATE latin1_general_ci,
  `sumario` text COLLATE latin1_general_ci,
  `observacoes` text COLLATE latin1_general_ci,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci AUTO_INCREMENT=6 ;

--
-- Extraindo dados da tabela `planejamento_projetos`
--

INSERT INTO `planejamento_projetos` (`id`, `titulo`, `cliente`, `responsavel_iets`, `responsavel_cliente`, `data_inicio`, `data_termino`, `valor`, `natureza_contrato`, `area_atuacao`, `overhead`, `taxa_administracao`, `objeto`, `sumario`, `observacoes`) VALUES
(1, 'beija me', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 'cobra coral', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 'festa', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 'mais um', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(5, 'eho rappa', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
